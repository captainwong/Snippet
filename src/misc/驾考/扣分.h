...
struct 简单扣分题目 : 扣分题目 {
	...
	简单扣分题目() : 扣分题目(0, 0) {}
	简单扣分题目(int id, const char* 描述, int 扣分) : 扣分题目(id, 扣分), 描述(描述) {}
...
static const 载人超载扣分规则 g_载人超载扣分规则[] = {
	{ __LINE__, {}, {}, 0 },
...
struct 载人超载扣分题目 : 扣分题目 {
	DECLARE_TYPE_ID
	载人超载扣分题目() : 扣分题目(0, 0) {}
	载人超载扣分题目(int id, 超载人扣分车型 车型, 超载范围 范围, int 扣分)
...
typedef std::shared_ptr<载人超载扣分题目> 载人超载扣分题目Ptr;


static const 简单扣分规则 g_载货超载扣分规则[] = {
	{ __LINE__, NULL, 0},
...
struct 载货超载扣分题目 : 扣分题目 {
	DECLARE_TYPE_ID
	std::string 描述;

	载货超载扣分题目() : 扣分题目(0, 0) {}
	载货超载扣分题目(int id, const char* 描述, int 扣分) : 扣分题目(id, 扣分), 描述(描述) {}

	virtual std::string question() const override {
		return 描述;
	}
};
typedef std::shared_ptr<载货超载扣分题目> 载货超载扣分题目Ptr;
...
static const 简单扣分规则 g_高速相关扣分规则[] = {
	{__LINE__, NULL, 0},
...
struct 高速相关扣分题目 : 简单扣分题目 {
	DECLARE_TYPE_ID

	高速相关扣分题目() : 简单扣分题目() {}
	高速相关扣分题目(int id, const char* 描述, int 扣分) : 简单扣分题目(id, 描述, 扣分) {}
};
typedef std::shared_ptr<高速相关扣分题目> 高速相关扣分题目题目Ptr;


static const 简单扣分规则 g_危险品运输相关扣分规则[] = {
	{__LINE__, NULL, 0},
...
struct 危险品运输相关扣分题目 : 简单扣分题目 {
	DECLARE_TYPE_ID

	危险品运输相关扣分题目() : 简单扣分题目() {}
	危险品运输相关扣分题目(int id, const char* 描述, int 扣分) : 简单扣分题目(id, 描述, 扣分) {}
};
typedef std::shared_ptr<危险品运输相关扣分题目> 危险品运输相关扣分题目Ptr;


static const 简单扣分规则 g_其他扣分规则[] = {
	{__LINE__, NULL, 0},
...
struct 其他扣分题目 : 简单扣分题目 {
	DECLARE_TYPE_ID

	其他扣分题目() : 简单扣分题目() {}
	其他扣分题目(int id, const char* 描述, int 扣分) : 简单扣分题目(id, 描述, 扣分) {}
};
